				...
				<div class="col-12 col-lg-10 mx-auto">
					<div class="card radius-15 rounded-lg shadow-lg">
						<div class="row no-gutters">
							<div class="col-lg-6">
								<img src="{{asset('public/images/logo-img.jpg')}}" class="card-img h-100" alt="...">
							</div>
							<div class="col-lg-6">
								<div class="card-body p-md-5">
									<div class="text-center">
										<img src="{{asset('public/images/currency.png')}}" width="80" alt="">
										<h1 class="mt-4 font-weight-bold">Welcome to {{ config('app.name') }} Login</h1>
										<h2>
                    					<p class="mb-8 text-gray-800">Book vet appointments seamlessly, manage your pets, and stay on top of care schedules.</p></h2>
										<hr/>
									</div>
